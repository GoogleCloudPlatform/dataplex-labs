# Lineage Use-Case: Impact analysis

## How to Run this use case

To run the defined code for this use case:
...
3. Choose to run a selection of tags. For use case you will chose the tag 'impact-analysis'
