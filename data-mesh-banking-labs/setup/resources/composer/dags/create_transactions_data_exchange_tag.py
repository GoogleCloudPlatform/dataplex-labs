...
TAG_INPUT_FILE = models.Variable.get('transactions_dx_input_file')
TAG_INPUT_PATH = models.Variable.get('transactions_dx_info_input_path')
SUB_NETWORK=models.Variable.get('gcp_sub_net')
TAG_JAR=models.Variable.get('gdc_tag_jar')
DPLX_TASK_PREFIX="trans-exchange-tag"
