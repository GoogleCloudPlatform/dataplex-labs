...
TAG_TEMPLATE = models.Variable.get('tag_template_data_product_classification') 
TAG_INPUT_FILE = models.Variable.get('customer_dc_input_file')
TAG_INPUT_PATH = models.Variable.get('customer_dc_info_input_path')
SUB_NETWORK=models.Variable.get('gcp_sub_net')
TAG_JAR=models.Variable.get('gdc_tag_jar')
DPLX_TASK_PREFIX="airflow-cust-dctag"
TAG_MAIN_CLASS=models.Variable.get('data_classification_main_class')
...
with models.DAG(
        'data_governance_customer_classification_tag',
