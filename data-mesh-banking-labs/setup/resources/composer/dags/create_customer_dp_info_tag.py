...
TAG_INPUT_FILE = models.Variable.get('customer_dp_info_input_file')
TAG_INPUT_PATH = models.Variable.get('customer_dp_info_input_path')
SUB_NETWORK=models.Variable.get('gcp_sub_net')
TAG_JAR=models.Variable.get('gdc_tag_jar')
DPLX_TASK_PREFIX="airflow-cust-dptag"
...
with models.DAG(
        'data_governance_customer_dp_info_tag',
