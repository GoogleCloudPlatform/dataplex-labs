...
from utils.constants import LOGS_DIRECTORY
...
def setup_file_logging():
    ...
    - Creates `logs/` directory at dataplex-glossary level if missing.
    ...
    # Ensure logs directory exists at dataplex-glossary level
    # Get the dataplex-glossary directory (parent of utils directory)
    utils_dir = os.path.dirname(os.path.abspath(__file__))
    dataplex_glossary_dir = os.path.dirname(utils_dir)
    logs_dir = os.path.join(dataplex_glossary_dir, LOGS_DIRECTORY)
