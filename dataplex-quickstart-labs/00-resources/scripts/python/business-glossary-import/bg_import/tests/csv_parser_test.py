...
class CsvReaderTest(unittest.TestCase):
  ...
  def test_read_glossary_csv_single_line(self, content):
    with mock.patch("builtins.open", mock.mock_open(read_data=content)):
      terms, errors, lines_read = csv_parser.parse_glossary_csv("")
  ...
  def test_read_glossary_csv_multi_line(self):
    content = (
        ...
        "term2,description2,,,,\n"
        'term3,description3,"name3<email3>, name33<email33>",,,'
    )
    ...
    with mock.patch("builtins.open", mock.mock_open(read_data=content)):
      ...
      self.assertEqual(
          terms[3].data_stewards, ["name3<email3>", "name33<email33>"],
      )
...
\"   \",description2,,,,"""
  ...
  def test_read_glossary_csv_non_allowed_character(self):
    content = """\"display\n name\",description1,<email@example.com>,,,"""
