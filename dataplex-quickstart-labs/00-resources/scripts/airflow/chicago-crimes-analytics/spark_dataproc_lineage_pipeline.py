...
# Bases
BASE_NM_CURATE_CRIMES="curate-crimes-spark-dataproc"
...
CURATE_CRIMES_DATAPROC_GCE_JOB_CONFIG = {
    "reference": {"job_id": BASE_NM_CURATE_CRIMES + f"-{JOB_ID}","project_id": PROJECT_ID},
...
CRIMES_BY_YEAR_DATAPROC_GCE_JOB_CONFIG = {
    ...
    "pyspark_job": {"main_python_file_uri": GCS_URI_CRIME_TRENDS_REPORT_PYSPARK,
                    ...
                    "properties": {"spark.openlineage.namespace": f"{PROJECT_ID}","spark.openlineage.appName": f"{REPORT_BASE_NM_CRIMES_YEAR}" }
                    }
}
...
CRIMES_BY_DAY_DATAPROC_GCE_JOB_CONFIG = {
    ...
    "pyspark_job": {"main_python_file_uri": GCS_URI_CRIME_TRENDS_REPORT_PYSPARK,
                    ...
                    "properties": {"spark.openlineage.namespace": f"{PROJECT_ID}","spark.openlineage.appName": f"{REPORT_BASE_NM_CRIMES_DAY}" }
                    }
}
...
CRIMES_BY_HOUR_DATAPROC_GCE_JOB_CONFIG = {
    ...
    "pyspark_job": {"main_python_file_uri": GCS_URI_CRIME_TRENDS_REPORT_PYSPARK,
                    ...
                    "properties": {"spark.openlineage.namespace": f"{PROJECT_ID}","spark.openlineage.appName": f"{REPORT_BASE_NM_CRIMES_HOUR}" }
                    }
}
